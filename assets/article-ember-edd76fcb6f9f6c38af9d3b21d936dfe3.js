...
var t=Ember.Controller.extend({actions:{edit:function(e){this.model.set("body",e),this.model.save(),this.transitionToRoute("/sentences")},createNew:function(e){var t=parseInt(this.model.sortOrder||this.model.firstObject.sortOrder)+1
...
var t=Ember.Route.extend({controllerName:"sentence",model:function(){return this.store.query("sentence",{query:function(e){return e.where("isDeleted","==",!1).orderBy("sortOrder","desc")}})},renderTemplate:function(e,t){this.render("new",{model:t})}})
...
var t=Ember.Route.extend({model:function(){return this.store.query("sentence",{query:function(e){return e.where("isDeleted","==",!1).orderBy("sortOrder","desc")}})},actions:{delete:function(e){e.set("isDeleted",!0),e.save(),this.refresh()},new:function(e){this.transitionTo("/new/"+e)},edit:function(e){this.transitionTo("/sentence/"+e.id)}}})
...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("article-ember/app").default.create({name:"article-ember",version:"0.0.0+b99aac20"})
