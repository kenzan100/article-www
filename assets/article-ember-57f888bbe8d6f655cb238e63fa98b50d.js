...
var t=Ember.Controller.extend({actions:{new:function(e){this.transitionToRoute("/new/"+e)},edit:function(e){this.transitionToRoute("/sentence/"+e.id)},delete:function(e){e.destroyRecord()}}})
...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("article-ember/app").default.create({name:"article-ember",version:"0.0.0+35228be8"})
