...
var t=Ember.Controller.extend({actions:{createNew:function(e){var t=this.model.sortOrder
this.model.isNew?this.updateOthersSaveAndExit(e,t):(this.model.set("body",e),this.model.save(),this.transitionToRoute("/sentences"))}},saveAndExit:function(e,t){this.store.createRecord("sentence",{body:e,sortOrder:t}).save(),this.transitionToRoute("/sentences")},updateOthersSaveAndExit:function(e,t){var r=this,n={query:function(e){return e.orderBy("sortOrder").startAt(parseInt(t,10))}}
...
var t=Ember.Controller.extend({actions:{new:function(e){this.transitionToRoute("/new/"+e)},edit:function(e){this.transitionToRoute("/sentence/"+e.id)},delete:function(e){e.deleteRecord(),e.save()}}})
...
var r=t.default.Model,n=t.default.attr,i=r.extend({body:n("string"),sortOrder:n("number")})
...
var t=Ember.Route.extend({controllerName:"sentence",model:function(e){return this.store.findRecord("sentence",e.sentence_id)},renderTemplate:function(e,t){this.render("new",{model:t})}})
...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("article-ember/app").default.create({name:"article-ember",version:"0.0.0+0b495f8c"})
